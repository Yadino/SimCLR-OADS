...
# mappings from: https://github.com/rgeirhos/generalisation-humans-DNNs/blob/master/16-class-ImageNet/MSCOCO_to_ImageNet_category_mapping.txt
...
class_mapping = {
    ...
    'dog': ['n02085782', 'n02085936', 'n02086079',
            'n02086240', 'n02086646', 'n02086910', 'n02087046', 'n02087394', 'n02088094', 'n02088238', 'n02088364',
            'n02088466', 'n02088632', 'n02089078', 'n02089867', 'n02089973', 'n02090379', 'n02090622', 'n02090721',
            'n02091032', 'n02091134', 'n02091244', 'n02091467', 'n02091635', 'n02091831', 'n02092002', 'n02092339',
            'n02093256', 'n02093428', 'n02093647', 'n02093754', 'n02093859', 'n02093991', 'n02094114', 'n02094258',
            'n02094433', 'n02095314', 'n02095570', 'n02095889', 'n02096051', 'n02096294', 'n02096437', 'n02096585',
            'n02097047', 'n02097130', 'n02097209', 'n02097298', 'n02097474', 'n02097658', 'n02098105', 'n02098286',
            'n02099267', 'n02099429', 'n02099601', 'n02099712', 'n02099849', 'n02100236', 'n02100583', 'n02100735',
            'n02100877', 'n02101006', 'n02101388', 'n02101556', 'n02102040', 'n02102177', 'n02102318', 'n02102480',
            'n02102973', 'n02104029', 'n02104365', 'n02105056', 'n02105162', 'n02105251', 'n02105505', 'n02105641',
            'n02105855', 'n02106030', 'n02106166', 'n02106382', 'n02106550', 'n02106662', 'n02107142', 'n02107312',
            'n02107574', 'n02107683', 'n02107908', 'n02108000', 'n02108422', 'n02108551', 'n02108915', 'n02109047',
            'n02109525', 'n02109961', 'n02110063', 'n02110185', 'n02110627', 'n02110806', 'n02110958', 'n02111129',
            'n02111277', 'n08825211', 'n02111500', 'n02112018', 'n02112350', 'n02112706', 'n02113023', 'n02113624',
            'n02113712', 'n02113799', 'n02113978']
}

# Define the directory paths
original_data_dir = r"D:\00 Downloads\imagenet-mini\train"
new_data_dir = r"D:\00 Downloads\imagenet-16"

# Create new directories for the new classes
for new_class in class_mapping.keys():
    os.makedirs(os.path.join(new_data_dir, new_class), exist_ok=True)


# Function to move images from original classes to new classes
def move_images(class_mapping, max_images=200):
    for new_class, original_classes in class_mapping.items():
        new_class_dir = os.path.join(new_data_dir, new_class)
        images_count = 0
        for original_class in original_classes:
            original_class_dir = os.path.join(original_data_dir, original_class)
            if os.path.exists(original_class_dir):
                ...
                for image in images:
                    if images_count >= max_images:
                        break
                    image_path = os.path.join(original_class_dir, image)
                    # Move the image to the new class directory
                    shutil.copy(image_path, new_class_dir)
                    images_count += 1
                    #   print(images_count)


# Move images while limiting the number of images in larger classes
move_images(class_mapping)
